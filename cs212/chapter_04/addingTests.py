...
>>> path_actions(bridge_problem([1,2,3]))
[(2, 1, '->'), (1, 1, '<-'), (3, 1, '->')]

>>> elapsed_time(bridge_problem([1,2,3]))
6

>>> path_states(bridge_problem([1,2,3]))
[(frozenset([1, 2, 3, 'light']), frozenset([]), 0), (frozenset([3]), frozenset([1, 2, 'light']), 2), (frozenset([1, 3, 'light']), frozenset([2]), 3), (frozenset([]), frozenset([1, 2, 3, 'light']), 6)]
"""
